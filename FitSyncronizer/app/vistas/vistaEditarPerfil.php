...
<head>
    ...
    <title>FitSyncronizer | Modificar Perfil</title>
    ...
    <link rel="stylesheet" href="web/css/crearModificarPerfilStyles.css">
</head>
        ...
        <section class="full-view-content">
            ...
            <div class="row">
                    <div class="form-container">
                        ...
                        <form action="index.php?accion=editarPerfil&id=<?= $perfil->getId() ?>" method="post" enctype="multipart/form-data">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="nombre_personal" name="nombre_personal" value="<?= htmlspecialchars($perfil->getNombrePersonal()) ?>" maxlength="100" required>
                            </div>
                            <div>
                                <label for="nombre_usuario_profesional">Nombre de Usuario Profesional:</label><br>
                                <input type="text" id="nombre_usuario_profesional" name="nombre_usuario_profesional" value="<?= htmlspecialchars($perfil->getNombreUsuarioProfesional()) ?>" maxlength="100" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" id="edad" name="edad" value="<?= htmlspecialchars($perfil->getEdad()) ?>" min="0" max="99" required>
                            </div>
                            <div>
                                <label for="anos_experiencia">Años de Experiencia:</label><br>
                                <input type="number" id="anos_experiencia" name="anos_experiencia" value="<?= htmlspecialchars($perfil->getAnosExperiencia()) ?>" min="0" max="99" required>
                            </div>
                            <div>
                                <label for="datos_contacto">Datos de Contacto (Email y teléfono):</label><br>
                                <input type="text" id="datos_contacto" name="datos_contacto" maxlength="200" value="<?= htmlspecialchars($perfil->getDatosContacto()) ?>" required>
                            </div>
                            <div>
                                <label for="trabajos_anteriores">Trabajos Anteriores:</label><br>
                                <textarea id="trabajos_anteriores" name="trabajos_anteriores" value="<?= htmlspecialchars($perfil->getTrabajosAnteriores()) ?>" maxlength="200" required></textarea>
                            </div>
                            <div>

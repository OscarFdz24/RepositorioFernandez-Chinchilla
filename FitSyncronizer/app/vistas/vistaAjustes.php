...
<head>
    ...
    <title>FitSyncronizer | Ajustes de Usuario</title>
            ...
            <div id="content-container">
                <div class="card m-2">
                    <div class="card-header">
                        <h1 class="card-title">Ajustes de usuario</h1>
                    </div>
                    <div class="card-body">
                        <p><strong>Nombre:</strong> <?php echo htmlspecialchars($usuario->getNombre()); ?></p>
                        <p><strong>Nombre de Usuario:</strong> <?php echo htmlspecialchars($usuario->getNombreUsuario()); ?></p>
                        <p><strong>Correo asociado:</strong> <?php echo htmlspecialchars($usuario->getCorreo()); ?></p>
                        <?php if (Sesion::getUsuario()->getRol() == "Profesional") : ?>
                            <p><strong>Teléfono:</strong> <?php echo htmlspecialchars($usuario->getTelefono()); ?></p>
                        <?php else : ?>
                            <p>No hay teléfono disponible debido al tipo del usuario.</p>
                        <?php endif; ?>
                        <hr>
                        <p>Se unió a FitSyncronizer o modificó sus datos el <strong><?php echo htmlspecialchars($fechaFormateada); ?></strong></p>
                        <!-- Botón para eliminar cuenta del usuario -->
                        <a href="index.php?accion=eliminarUsuario&id=<?php echo htmlspecialchars($usuario->getId()) ?>" class="btn btn-danger">Eliminar cuenta</a>

                        <!-- Botón para modificar datos del usuario -->
                        <a href="index.php?accion=modificarDatosUsuario" class="btn btn-primary">Modificar datos</a>
                    </div>
                </div>
            </div>
            </div>
        ...
        <main class="main_small">
            ...
            <div class="card m-5">
                    ...
                    <div class="card-body">
                        ...
                        <p>Se unió a FitSyncronizer o modificó sus datos el <strong><?php echo htmlspecialchars($fechaFormateada); ?></strong></p>
                        <!-- Botón para eliminar cuenta del usuario -->
                        <a href="index.php?accion=eliminarUsuario&id=<?php echo htmlspecialchars($usuario->getId()) ?>" class="btn btn-danger mb-2">Eliminar cuenta</a>

                        <!-- Botón para modificar datos del usuario -->
                        <a href="index.php?accion=modificarDatosUsuario" class="btn btn-primary mb-2">Modificar datos</a>
                    </div>
                </div>

...
<head>
    ...
    <title>FitSyncronizer | Listar Entrenamientos</title>
    ...
    <link rel="stylesheet" href="web/css/listarStyles.css">
</head>
...
<body>
    ...
    <main>
        ...
        <section class="full-view-content">
            ...
            <h1>Entrenamientos creados: <span id="contadorEntrenamientos"><?php echo htmlspecialchars($cantidadEntrenamientos) ?></span></h1>
                <div class="btn-cont">
                    <a href="index.php?accion=crearEntrenamiento" class="btn-100">Añadir Entrenamiento</a>
                </div>
                ...
                <div class="row">
                    <?php if (count($entrenamientos) > 0) : ?>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card__header">
                                        <h1 class="title title--Primary"><?php echo htmlspecialchars($entrenamiento->getGrupoMuscular()) ?></h1>
                                        <h3><?php echo htmlspecialchars($entrenamiento->getDia()) ?></h3>
                                        <h3 class="fecha__title">Creado el: <?php echo htmlspecialchars($entrenamiento->getFecha()) ?></h3>
                                    </div>
                                    <div class="card__body">
                                        <pre><?= htmlspecialchars_decode($entrenamiento->getRutina()) ?></pre>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 m-0 p-2 col--deleteButton">
                                            <a class="deleteLink" href="#" data-entrenamiento-id="<?php echo $entrenamiento->getId() ?>">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </a>
                                        </div>
                                        <div class="col-6 m-0 p-2 col--modifierButton">
                                            <a href="index.php?accion=editarEntrenamiento&id=<?php echo $entrenamiento->getId() ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 m-0 p-2 col--viewButton">
                                            <a href="index.php?accion=mostrarEntrenamiento&id=<?php echo $entrenamiento->getId() ?>"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php endforeach; ?>
                    <?php else : ?>
                        <p>No tienes ningun entrenamiento</p>
                    <?php endif; ?>
                </div>
            </div>
            </div>
    ...
    <div class="content-small">
        ...
        <main class="main_small">
            <div id="content-container">
                <h3>Entrenamientos creados: <?php echo htmlspecialchars($cantidadEntrenamientos) ?>/7</h3>
                <a href="index.php?accion=crearEntrenamiento" class="btn-100 btn-small">Añadir Entrenamiento</a>
                <div class="row">
                    <?php if (count($entrenamientos) > 0) : ?>
                        <?php foreach ($entrenamientos as $entrenamiento) : ?>
                            <div class="col-6">
    ...
    <script src="web/archivosJS/entrenamientos.js"></script>
</body>

            ...
            <div id="content-container">
                <div class="row">
                    <div class="form-container">
                        ...
                        <form action="index.php?accion=crearPerfil" method="POST" enctype="multipart/form-data">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="nombre_personal" name="nombre_personal" maxlength="100" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" id="anos_experiencia" name="anos_experiencia" min="0" max="99" required>
                            </div>
                            <div>
                                <label for="datos_contacto">Datos de Contacto:</label><br>
                                <input type="text" id="datos_contacto" name="datos_contacto" maxlength="200" required>
                            </div>
                            <div>
                                <label for="trabajos_anteriores">Trabajos Anteriores:</label><br>
                                <textarea id="trabajos_anteriores" name="trabajos_anteriores" maxlength="200" required></textarea>
                            </div>
                            <div>

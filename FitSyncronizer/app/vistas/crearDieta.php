...
<head>
    ...
    <title>FitSyncronizer |Crear dieta</title>
            ...
            <div id="content-container">
                ...
                <div class="row">
                    <div class="form-container">
                        ...
                        <form action="index.php?accion=crearDieta" method="post" class="training-form">
                            <div class="form-group">
                                <label for="nombre_dieta">Nombre de la Dieta:</label>
                                <input type="text" name="nombre_dieta" id="nombre_dieta" maxlength="250" required>
                            </div>
                            <div class="form-group">
                                <label for="descripcion">Descripción:</label>
                                <textarea class="jqte" style="width: 90%;" name="descripcion" id="descripcion" rows="18" maxlength="1250" required></textarea>
                            </div>
                            <div class="form-group">

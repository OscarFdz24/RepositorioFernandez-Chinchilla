...
<head>
    ...
    <title>FitSyncronizer | Modificar Usuario</title>
        ...
        <section class="full-view-content">
            <div id="content-container">
                ...
                <div class="card m-2">
                    ...
                    <div class="card-body">
                        <form action="index.php?accion=modificarDatosUsuario" method="post">
                            <div class="form-group">
                                <label for="nombre">Nombre:</label>
                                <input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo htmlspecialchars($usuario->getNombre()); ?>">
                            </div>
                            <div class="form-group">
                                <label for="nombre_usuario">Nombre de Usuario:</label>
                                <input type="text" id="nombre_usuario" name="nombre_usuario" class="form-control" value="<?php echo htmlspecialchars($usuario->getNombreUsuario()); ?>">
                            </div>
                            <div class="form-group">
                                <label for="rol">Rol:</label>
                                <select id="rol" name="rol" class="form-control">
                                    <option value="Normal" <?php echo $usuario->getRol() == 'Normal' ? 'selected' : ''; ?>>Normal</option>
                                    <option value="Profesional" <?php echo $usuario->getRol() == 'Profesional' ? 'selected' : ''; ?>>Profesional</option>
                                    <option value="Administrador" <?php echo $usuario->getRol() == 'Administrador' ? 'selected' : ''; ?>>Administrador</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="correo">Correo asociado:</label>
                                <input type="email" id="correo" name="correo" class="form-control" value="<?php echo htmlspecialchars($usuario->getCorreo()); ?>">
                            </div>
                            <div class="form-group">

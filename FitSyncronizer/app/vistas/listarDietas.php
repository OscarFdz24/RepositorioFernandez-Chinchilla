...
<head>
    ...
    <title>FitSyncronizer |Listar Dietas</title>
...
<body>
    ...
    <main>
        ...
        <section class="full-view-content">
            ...
            <h1>Dietas creadas: <span id="contadorDietas"><?php echo htmlspecialchars($cantidadDietas) ?></span></h1>
                <div class="btn-cont">
                    <a href="index.php?accion=crearDieta" class="btn-100">Añadir Dieta</a>
                </div>
                ...
                <div class="row">
                    <?php if (count($dietas) > 0) : ?>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card__header">
                                        <h1 class="title title--Primary"><?php echo htmlspecialchars($dieta->getNombreDieta()) ?></h1>
                                            <?php if ($dieta->getEnProceso() == 1) : ?>
                                                <h3> En proceso</h3>
                                            <?php else : ?>
                                                <h3> En pausa</h3>
                                            <?php endif; ?>
                                        <h3 class="fecha__title">Creada el: <?php echo htmlspecialchars($dieta->getFecha()) ?></h3>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <a class="deleteLink" href="#" data-dieta-id="<?php echo $dieta->getId() ?>">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </a>
                                        </div>
                                        <div class="col-6 m-0 p-2 col--modifierButton">
                                            <a href="index.php?accion=editarDieta&id=<?php echo $dieta->getId() ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 m-0 p-2 col--viewButton">
                                            <a href="index.php?accion=mostrarDieta&id=<?php echo $dieta->getId() ?>"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php endforeach; ?>
                    <?php else : ?>
                        <p>No tienes ninguna dieta creada</p>
                    <?php endif; ?>
                </div>
            </div>
            </div>
    ...
    <div class="content-small">
        ...
        <main class="main_small">
            <div id="content-container">
                <h3>Dietas creadas: <?php echo htmlspecialchars($cantidadDietas) ?>/7</h3>
                <a href="index.php?accion=crearDieta" class="btn-100 btn-small">Añadir Dieta</a>
                <div class="row">
                    <?php if (count($dietas) > 0) : ?>
                        <?php foreach ($dietas as $dieta) : ?>
                            <div class="col-6">
    ...
    <script src="web/archivosJS/dietas.js"></script>
</body>

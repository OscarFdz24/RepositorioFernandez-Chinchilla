...
<head>
    ...
    <title>FitSyncronizer | Mostrar Entrenamiento</title>
        ...
        <section class="full-view-content">
            ...
            <div id="content-container">
                <div class="row">
                    ...
                    <h2 class="data-entrenamiento__date">- Creado el: <?php echo htmlspecialchars($entrenamiento->getFecha()) ?></h2>
                    <h2 class="data-entrenamiento__group">- Grupo muscular: <?php echo htmlspecialchars($entrenamiento->getGrupoMuscular()) ?></h2>
                    <hr class="separator">
                    ...
                    <div class="data-entrenamiento__buttons">
                        <div class="buttons buttons--delete">
                            <a class="deleteLink" href="index.php?accion=eliminarEntrenamiento&id=<?php echo $entrenamiento->getId() ?>"><i class="fa-regular fa-trash-can"></i> Eliminar</a>
                        </div>
        ...
        <main class="main_small">
            <div id="content-container">
                ...
                <h2 class="data-entrenamiento__title">- Propietario: <?= Sesion::getUsuario()->getNombreUsuario() ?></h2>
                    ...
                    <div class="card data-entrenamiento__card">
                        <div class="card__body">
                            <p><?php echo htmlspecialchars($entrenamiento->getRutina()) ?></p>
                        </div>
                    </div>
                    <div class="data-entrenamiento__buttons">
                        <div class="buttons buttons--delete">
